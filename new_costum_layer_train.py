...
labels = df.unique_id.values

# tokenizer
print("histogram:  ", Counter(labels).values())
...
model = CustomModel(num_labels=2,  # The number of output labels--2 for binary classification.
                    )
...
for epoch_i in range(0, epochs):
    ...
    # save model
    torch.save(model, "./src/Output_models/BERT_model{0:.2f}_costum.model".format(avg_val_accuracy))
