...
df = pd.read_csv("./data/cheated_full_train.csv", encoding="utf-8", quoting=1)
...
torch.save(model, "./src/Output_models/BERT_model{0:.2f}_cheated.model".format(avg_val_accuracy))
