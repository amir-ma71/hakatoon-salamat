...
bert = AutoModel.from_pretrained('./src/bert-fa-base-uncased')

# Load the BERT tokenizer
tokenizer = BertTokenizerFast.from_pretrained('./src/bert-fa-base-uncased')
...
class BERT_Arch(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv1 = nn.Conv1d(in_channels=250, out_channels=768, kernel_size=3)
        self.relu1 = nn.ReLU()
        ...
        self.relu3 = nn.ReLU()
        self.linear2 = nn.Linear(256, 128)  ## 3 is the number of classes in this example
        self.relu4 = nn.ReLU()
    ...
    def forward(self, ids, mask):
        ...
        flatten = self.flatten(drop2_output)
        linear1_output = self.linear1(flatten[0, :].view(-1, 256))  ## extract the 1st token's embeddings
